                                ...
                                while($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($row_exist) {
                                        ...
                                        if ($curr_date == $todays_date) {
                                            ...
                                            echo "<td><div class='text-center'><a href='actions/check-attendance.php?id={$row['user_id']}'><button class='btn btn-info'>Check In <i class='fas fa-map-marker-alt'></i></button></a></div></td>";
                                        }
                                    } else {
                                        echo "<td><div class='text-center'><a href='actions/check-attendance.php?id={$row['user_id']}'><button class='btn btn-info'>Check In <i class='fas fa-map-marker-alt'></i></button></a></div></td>";
                                    }
